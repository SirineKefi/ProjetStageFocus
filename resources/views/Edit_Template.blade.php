                                ...
                                <table style='margin-left:50px'>
                                    ...
                                    <td  >
                                      <br>
                                        ...
                                        <td >
                                        <br>
                                      <input type="number" value="{{$template->LPAR_id}}" class ="form-control" min="1"  name="LPAR_id" id="id_LPAR_id">
                                        </td>
                                    ...
                                    <br>
                                        ...
                                        <td >
                                          <br>
                                            <input type="text" value="{{$template->LPAR_name}}" class ="form-control"  name="template_name" id="id_template_name">
                                        </td>
                                                </tr>
                                                <tr>
                                        <td >
                            ...
                            <div class='panel' >  
                                ...
                                <table id="table_shared" style='margin-left:50px;display: block;' >
                                    <tr>
                                        ...
                                        <td>
                                        <input type='number' min="0" value="{{$template->min_proc_units}}" placeholder="0.1" step="0.1" class ='form-control' name='min_proc_units' id="id_min_proc_units">
                                        </td>
                                        <td style='text-align:right'>
                                             Minimum virtual processors *
                                        </td>
                                        <td>
                                            <input type='number' min="0" value="{{$template->min_v_proc}}" step="0.1" placeholder="0.1" class ='form-control' name='min_v_proc' id="id_min_v_proc">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td >
                                        ...
                                        <td>
                                        <br>
                                            <input type='number' min="0" value="{{$template->disired_proc_units}}"  step="0.1" placeholder="0.1" name='desired_proc_units' class ='form-control' id="id_desired_proc_units">
                                        </td>
                                        <td style='text-align:right' >
                                        <br>
                                            ...
                                            <td>
                                            <br>
                                                <input type='number' min="0" step="0.1" value="{{$template->disired_v_proc}}" placeholder="0.1" name='desired_v_proc' class ='form-control' id="id_desired_v_proc">
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <br>
                                                ...
                                                <input type='number' min="0" step="0.1" value="{{$template->max_proc_units}}" placeholder="0.1" name='max_proc_units' class ='form-control' id="id_max_proc_units">
                                            </td>
                                            ...
                                            <td>
                                            <br>
                                                <input type='number' min="0" step="0.1" value="{{$template->max_v_proc}}" placeholder="0.1" name='max_v_proc' class ='form-control' id="id_max_v_proc">
                                            </td>
                                        ...
                                        <td>
                                         ...
                                         Uncapped weight*
                                            ...
                                            <td>
                                            <br>
                                            <input type="number" style="display:block" value="{{$template->uncap_weight}}" min="0" class ='form-control' id="id_uncap_weight" name="uncap_weight">
                                            </td>
                                            @endif
                                        </tr>

                    <input id="uncap_secret" hidden value="{{$template->sharing_mode}}"  >
                                           
                                        </tr>
                                    </table>
                                    <input type="text" hidden id="shared_1" value="{{$template->shared}}">
                                       ...
                                       <p id="p_dedicated" style="display: none"> <B>    Specify the desired, minimum, and maximum processing settings in the fields below.</B></p>
                                          <table id="table_dedicated" style='margin-left:50px;display: none;' >
                                                      <tr>
                                                          ...
                                                          <input type='number' min="0" value='{{$template->min_proc}}' placeholder="1" class ='form-control' name='min_proc' id="id_min_proc">
                                                          </td>
                                                      </tr>
                                                      <tr>
                                                          <td>
                                                          ...
                                                          <td>
                                                          <br>
                                                          <input type='number' min="0" value='{{$template->desired_proc}}' placeholder="1" class ='form-control' name='desired_proc' id="id_desired_proc">
                                                          </td>
                                                      </tr>
                                                      <tr>
                                                          <td>
                                                          ...
                                                          <td>
                                                          <br>
                                                          <input type='number' min="0" placeholder="1" value='{{$template->max_proc}}' class ='form-control' name='max_proc' id="id_max_proc">
                                                          </td>
                                                     </tr>
                                              </table>
                                            <br>
                            ...
                            <div class="panel">
                                <table >
                                    <tr>
                                        ...
                                        <td >
                                             <input  class ="form-control" value="{{$template->min_memory}}" type="range" min="0" max="256" step="0.1" value="0" class="slider" id="myRange">
                                        </td> 
                                        <td style="text-align:right">
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                             <input class ="form-control"  value="{{$template->disired_memory}}" type="range" min="0" max="256" step="0.1" value="0" class="slider1" id="myRange1">
                                        </td> 
                                        <td style="text-align:right">
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                             <input class ="form-control"  type="range" name="max_memo"  value="{{$template->max_memory}}"  step="0.1" min="0" max="256" value="0" class="slider2" id="myRange2">
                                        </td> 
                                        <td style="text-align:right">
            ...
            <div class="modal fade" id="myModal1">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  {!!Form::open(['action' => ['LparController@createphysicalIO',$client->id,$template->id], 'method' => 'POST'])!!}       
...
<br>
           ...
           <td style="width:20%">
            <input type="number" placeholder="0" min="0" value="{{$template->max_v_adapters}}" name="max_v_adapters" id="id_max_v_adapters"  class="form-control form-control-sm" > 
           </td>
           <td style="width:30%">
           </td>
           <td style="width:10%">
          ...
          <?php
           ...
           <tr> 
            <td style="width:40%;text-align:right">
                ...
                {!!Form::open(['action' => ['LparController@createSCSI',$client->id,$template->id], 'method' => 'POST'])!!}       
...
<table>
          ...
          <table  >
            ...
            <td style="width:40%;text-align:center">
               ...
               {!!Form::open(['action' => ['LparController@createEthernet',$client->id,$template->id], 'method' => 'POST'])!!}       
    ...
    <input type="text" placeholder="Enter vswitch name ..." style="display:none" name="hidden_vs" class="form-control" id="id_vs_hidden">
            ...
            {!!Form::open(['action' => ['LparController@createFC',$client->id,$template->id], 'method' => 'POST'])!!}       
...
<br>
   ...
   <button class="accordion"><i class="fas fa-angle-double-right"></i> Optional Settings</button>
        ...
        <?php 
          $server=Server::find($template->Server_FK_id);
          $client=Client::find($server->Client_FK_id);
          ?>
                    <div class="col-lg-6" style="text-align:left">

        {!!Form::open(['action' => ['TemplateController@edit',$client->id,$server->id,$template->id], 'method' => 'GET'])!!}       
